...
public class FinanceStockMarketMapperProvider {
    ...
    public static String insertAndAppend(@Param("market") FinanceStockMarket market){
        ...
        sql.append(" INSERT INTO `finance_stock_market` (`stock_code`, `stock_name`, `stock_date`, `current`, `stock_open`, `high`, `low`, `stock_close`, `stock_change`, `stock_change_pct`, `volume`, `amount`, `swing`, `is_deleted`, `gmt_create`, `gmt_modified`, `ts`) VALUES ( ");
